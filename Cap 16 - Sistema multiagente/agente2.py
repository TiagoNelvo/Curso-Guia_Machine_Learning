...
class ComportamentoComprador(FipaRequestProtocol):
    ...
    def handle_imform(self, message):
...
class AgenteComprador(Agent):
    def __init__(self,aid, nome):
        super(AgenteComprador).__init__(aid=aid)        
        ...
        self.comport_temp = ComportamentoComprador(self, 8.0, mensagem)
...
# No terminal    
# pade start-runtime --port 20000 agente2.py